...
typedef struct _CAPSTONE_MainData {
    uint32_t startTime; /* Time since zeroed out */
...
#define CAPSTONE_MainData_init_default           {0, 0, 0, {{NULL}, NULL}}
#define CAPSTONE_MainData_init_zero              {0, 0, 0, {{NULL}, NULL}}

/* Field tags (for use in manual encoding/decoding) */
#define CAPSTONE_MainData_startTime_tag          1
#define CAPSTONE_MainData_totalCount_tag         2
#define CAPSTONE_MainData_pulseTime_tag          3
#define CAPSTONE_MainData_spectrum_tag           4

/* Struct field encoding specification for nanopb */
#define CAPSTONE_MainData_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UINT32,   startTime,         1) \
X(a, STATIC,   SINGULAR, FLOAT,    totalCount,        2) \
X(a, STATIC,   SINGULAR, INT32,    pulseTime,         3) \
X(a, CALLBACK, REPEATED, UINT32,   spectrum,          4)
